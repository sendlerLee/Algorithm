...
void read_train_data(Problem& TrProb, std::string const &path)
{
	...
	/*
	TrProb.inst2features.shrink_to_fit();
	TrProb.feat2sortinstances.shrink_to_fit();
	TrProb.Y.shrink_to_fit();
	*/
...
void read_test_data(Problem& TrProb, Problem& VaProb, std::string const &path)
{
	...
	/*
	VaProb.inst2features.shrink_to_fit();
	VaProb.feat2sortinstances.shrink_to_fit();
	VaProb.Y.shrink_to_fit();
	*/
